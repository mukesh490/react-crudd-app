    ...
    return (
        <div className=' min-h-screen bg-gray-100 flex  justify-center item-start py-10'>
            <div className='w-full max-w-3xl bg-white shadow-lg rounded-lg p-6'>
                <h1 className='text-center text-2xl font-semibold mb-6'>{`${editUser?'Update User':'Add User'}`}</h1>
                <Formik
                    enableReinitialize
                    initialValues={{
                        name: editUser?.name || '',
                    ...
                    {({ setFieldValue, isSubmitting, values, resetForm }) => (
                        <Form className="space-y-4" >
                            ...
                            <div>
                                ...
                                <Field type='text' name='phone' placeholder="Enter phone No" className='w-full border rounded-md border-gray-300 py-2 px-3 focus:outline-none focus:ring-2 focus:ring-blue-500' />
                                <ErrorMessage
                                    name="phone"
                                    component="p"
                                    className="text-red-500 text-sm mt-1"
